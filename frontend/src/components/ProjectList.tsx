...
function ProjectList({ selectedCategories }: { selectedCategories: string[] }) {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        setLoading(true);
        const data = await fetchProjects(pageSize, pageNum, selectedCategories); //remember to pass in all of this
        ...
        //finally is if there is an error then it will do soemthing
        setLoading(false);
      }
    };
    loadProjects();
